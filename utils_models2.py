...
class YOLOModel:
    ...
    def transfer_training(self, additionaldata_yaml, originaldata_yaml, intermediate_weights='models/phase1.pt', debug_mode=False, **kwargs):
        """
    ...
    def grid_search(self, data_yaml='data.yaml', epochs=50, param_grid=None, result_file='grid_search_results.json'):
